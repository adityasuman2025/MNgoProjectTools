        ...
        <Modal open={open} title={title || "Install Web App"} onClose={onClose} >
            <div>
                ...
                {platform === PLATFORMS.IDEVICE && (
                    <div>
                        <div className="pwaContentLine"><div>Tap the share button:</div> {SHARE_SVG}</div>
                ...
                {platform === PLATFORMS.FIREFOX && (
                    <div>
                        <div className="pwaContentLine"><div>Tap this icon on the address bar:</div> {HOME_SVG}</div>
                ...
                {platform === PLATFORMS.FIREFOX_NEW && (
                    <div>
                        <div className="pwaContentLine"><div>Tap the ellipsis button:</div> {ELLIPSIS_SVG}</div>
                        then tap 'Install'
                ...
                {platform === PLATFORMS.OPERA && (
                    <div>
                        <div className="pwaContentLine"><div>Tap the ellipsis button:</div> {ELLIPSIS_SVG}</div>
                        <div className="pwaContentLine">then tap '{HOME_SVG} Home screen'</div>
                        then tap 'Install'
